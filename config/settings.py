...
# -----------------------------
# ML inference service (ml_service/api_server.py in project root)
# -----------------------------
...
def _resolve_ml_root() -> str:
    """Use ml_service inside the repo; ignore ML_ROOT_PATH that points outside."""
    default = str((PROJECT_ROOT / "ml_service").resolve())
